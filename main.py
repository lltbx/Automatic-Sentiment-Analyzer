...
#-------------------------------------------------------------------------------
# Ensure test_labels is a 1D array (handle potential shape issues)

# theta, theta_0 = p1.pegasos(train_bow_features, train_labels, T=25, L=0.01)
# print("Learned theta vector:", theta)

# # Make predictions on the test set
# test_predictions = p1.classify(test_bow_features, theta, theta_0)

# # Compute accuracy on the test set using the provided accuracy function
